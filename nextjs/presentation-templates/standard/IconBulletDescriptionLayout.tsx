...
const IconSchema = z.object({
	__icon_url__: z
		.string()
		.default('/static/icons/bold/fediverse-logo-bold.svg')
		.meta({
		...
		.default([
			{
				symbolText: 'i',
				symbolIcon: {
					__icon_url__: '/static/icons/bold/fediverse-logo-bold.svg',
					__icon_query__: 'info icon',
				},
			...
			},
			{
				symbolText: 'i',
				symbolIcon: {
					__icon_url__: '/static/icons/bold/video-bold.svg',
					__icon_query__: 'info icon',
				},
			...
			},
			{
				symbolText: 'i',
				symbolIcon: {
					__icon_url__: '/static/icons/bold/receipt-x-bold.svg',
					__icon_query__: 'info icon',
				},
			...
			},
			{
				symbolText: 'i',
				symbolIcon: {
					__icon_url__: '/static/icons/bold/users-four-bold.png',
					__icon_query__: 'info icon',
				},
				title: 'Customer-Centric Disruption',
				description:
					...
					<div className="flex items-center gap-[24px]">
						...
						>
							<rect
								...
								height="2"
								rx="1"
								style={{ fill: 'var(--text-heading-color, #111827)' }}
							></rect>
						</svg>
					</div>
					{/* page number removed */}
				...
				<div className="relative z-10 grid grid-cols-[600px_1fr] gap-[64px] px-[80px] pt-[12px]">
										...
										>
											{item.symbolIcon?.__icon_url__ ? (
												...
												<span
													...
													style={{
														color: 'var(--primary-accent-color, #1B8C2D)',
													}}
												>
													{item.symbolText}
												</span>
					...
					<div className="pt-[28px]">
						...
						<div
							...
							style={{
								backgroundColor: 'var(--secondary-accent-color, #F3F4F6)',
							}}
						>
							<p
