...
const IconSchema = z
	.object({
		__icon_url__: z.string().default('/static/icons/bold/file-text-bold.svg'),
		__icon_query__: z.string().min(0).max(80).default('feature icon'),
	})
	.default({
		__icon_url__: '/static/icons/bold/file-text-bold.svg',
		...
		features: z
			...
			.default([
				FeatureSchema.parse({}),
				{
					...
					icon: IconSchema.parse({
						__icon_url__: '/static/icons/bold/devices-bold.svg',
					}),
				},
				{
							...
							>
								<div className="px-6 py-5">
									<div
										...
										style={{
											backgroundColor: 'var(--secondary-accent-color, #FFFFFF)',
										}}
									>
										<RemoteSvgIcon
