...
const ItemSchema = z
	...
	.default({
		icon: {
			__icon_url__: '/static/icons/bold/graduation-cap-bold.svg',
	...
	.object({
		...
		items: z
			...
			.default([
				...
				{
					icon: {
						__icon_url__: '/static/icons/bold/user-bold.svg',
						__icon_query__: 'feature icon',
					},
					title: 'Lorem ipsum dolor',
					description:
				...
				{
					icon: {
						__icon_url__: '/static/icons/bold/calendar-blank-bold.svg',
						__icon_query__: 'feature icon',
					},
					title: 'Lorem ipsum dolor',
					description:
				...
				{
					icon: {
						__icon_url__: '/static/icons/bold/x-bold.svg',
						__icon_query__: 'feature icon',
					},
					title: 'Lorem ipsum dolor',
					description:
