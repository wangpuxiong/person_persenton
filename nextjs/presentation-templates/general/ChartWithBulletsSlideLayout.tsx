			...
			>
				{(slideData as any)?.__companyName__ && (
					<div className="absolute top-0 left-0 right-0 px-8 sm:px-12 lg:px-20 pt-4">
						<div className="flex items-center gap-4">
							...
							<div
								className="h-[2px] flex-1 opacity-70"
								style={{
				...
				<div className="flex h-full px-8 sm:px-12 lg:px-20 pt-8 pb-8">
					...
					<div className="flex-1 flex flex-col pr-8">
						...
						{/* Chart Container */}
						<div
							className="flex-1 rounded-lg shadow-sm border border-gray-100 p-4"
							style={{ background: 'var(--primary-accent-color,#F5F8FE)' }}
						>
					...
					<div className="flex-shrink-0 w-80 flex flex-col justify-center space-y-4">
						{bulletPoints.map((bullet, index) => (
							...
							>
								...
								{/* Description */}
								<p
									style={{ color: 'var(--text-body-color,#ffffff)' }}
